...
__constant int preserved_constant_f2, removed_constant_l2 = 2;
__constant int * __constant preserved_constant_pointer_f2, * __constant removed_constant_pointer_l2 = &removed_constant_l2;
__constant int preserved_constant_array_f2[1], removed_constant_array_l2[1] = { 2 };
...
__constant int removed_constant_f4, preserved_constant_l4 = 4;
__constant int * __constant removed_constant_pointer_f4, * __constant preserved_constant_pointer_l4 = &removed_constant_f4;
__constant int removed_constant_array_f4[1], preserved_constant_array_l4 = { 4 };
...
__constant int preserved_constant_f6, removed_constant_m6, preserved_constant_l6 = 6;
__constant int * __constant preserved_constant_pointer_f6, * __constant removed_constant_pointer_m6, * __constant preserved_constant_pointer_l6 = &removed_constant_m6;
__constant int preserved_constant_array_f6[1], removed_constant_array_m6[1], preserved_constant_array_l6[1] = { 6 };
...
__constant int removed_constant_f8, preserved_constant_m8, removed_constant_l8 = 8;
__constant int * __constant removed_constant_pointer_f8, * __constant preserved_constant_pointer_m8, * __constant removed_constant_pointer_l8 = &removed_constant_f8;
__constant int removed_constant_array_f8[1], preserved_constant_array_m8[1], removed_constant_array_l8[1] = { 8 };
...
__constant int removed_constant_f10, removed_constant_m10, removed_constant_l10 = 10;
__constant int * __constant removed_constant_pointer_f10, * __constant removed_constant_pointer_m10, * __constant removed_constant_pointer_l10 = &removed_constant_m10;
__constant int removed_constant_array_f10[1], removed_constant_array_m10[1], removed_constant_array_l10[1] = { 10 };
